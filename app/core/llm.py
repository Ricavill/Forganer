...
SYSTEM_PROMPT = (
    ...
    "After the meet is created, ask the user if they'd like you to email everyone a calendar "
    "invite (works with iPhone/Apple Mail, Google Calendar, Outlook, etc.) using "
    "send_meet_invites. Only call that tool after the user explicitly confirms - never send "
